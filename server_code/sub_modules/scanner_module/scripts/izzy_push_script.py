...
IZZY_INDEX_URL = "https://apt.izzysoft.de/fdroid/repo/index-v1.json"
WORKER_URL     = "https://api.colourswift.com/admin/store/izzy-index-chunk"
...
print("Fetching IzzyOnDroid index...")
try:
    with urllib.request.urlopen(IZZY_INDEX_URL, timeout=300) as res:
        raw_data = res.read()
...
req = urllib.request.Request(
    WORKER_URL.replace("/izzy-index-chunk", "/izzy-index"),
    data=raw_data,
    method="PUT",
    headers={
        "authorization": SECRET,
